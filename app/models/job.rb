class Job < ApplicationRecord
	...
	validates :years_experience, numericality: { :minimum => 0, :less_than_or_equal_to => 50, message: "Experience Required (Years) field should be a numeric."}, presence: { message: "Experience Required (Years) field should be a numeric." }
